...
episodes - Number of episodes in the anime. Animes that are 'currently airing' or 'not yet aired' will have their total allocated episodes reflected. For example if an anime has only aired 5 episodes but is set to run 24, 24 episodes will be reflected. Animes with unknown number of episodes is left blank.
...
source - Indicates the nature of the source material of the anime. i.e. manga/web novel
